...
class OptimalIVBinning(BaseBinning):
    """最优IV分箱.
    ...
    **示例**
    ...
    >>> from hscredit.core.binning import OptimalIVBinning
    ...
    **注意**
    ...
    def _calc_iv(
        ...
        eps = 1e-10
        # 平滑处理：将0替换为eps，参考scorecardpy的做法
